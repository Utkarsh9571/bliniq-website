  ...
  const items = [
    {
      ...
      desc: "Consult with a highly-rated surgeon with 18+ years of clinical experience.",
      icon: (
    ...
    },
    {
      ...
      desc: "USFDA approved laser fat-removal technology with zero scars.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
    ...
    {
      title: "Fast Recovery",
      desc: "Painless procedure allows you to return to normal life in 48 hours.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
    ...
    },
    {
      ...
      desc: "Get absolute clarity on surgery packages upfront with zero hidden charges.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
    ...
    {
      title: "No-Cost EMI",
      desc: "Pay in easy monthly installments with 0% interest and zero downpayment options.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
    ...
    },
    {
      ...
      desc: "Get a personal medical coordinator assisting you at every step of hospital care.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
