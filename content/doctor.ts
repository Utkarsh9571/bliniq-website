...
export const DOCTOR_DATA: DoctorData = {
  ...
  qualifications: [
    ...
    "Specialist in High-Definition 4D liposuction",
  ...
  description: "Dr. Ashwani Kumar is a renowned, board-certified plastic and reconstructive surgeon with over 18 years of clinical excellence. Having performed over 3,000 successful surgeries, he is considered one of the foremost authorities in High-Definition Ultrasound-assisted body contouring, male chest reduction, and structural nasal rhinoplasty in the Delhi NCR region."
};
